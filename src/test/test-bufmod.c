...
static char const ident[] __attribute__ ((unused)) = "src/test/test-bufmod.c (" PACKAGE_ENVR ") " PACKAGE_DATE;

/*
 *  This is a ferry-clip BUFMOD conformance test program for testing the OpenSS7
 *  bufmod STREAMS module.
 *
 *  GENERAL OPERATION:
 *
 *  The test program opens STREAMS pipe and pushes the "bufmod" module onto one
 *  end of the pipe.
 *
 *  The test program exchanges SDTI primitives with one side of the open pipe
 *  and exchanges SDTI primitives and executes BUFMOD input-output controls on
 *  the other side of the pipe.  The side of the pipe with the "bufmod" STREAMS
 *  module pushed represents the user of the BUFMOD module.  The other side of
 ...
 *
 *
 *  This test arrangement results in a ferry-clip around the BUFMOD module,
...
#define test_group_1 "Pushing and popping the bufmod module"
...
This test case tests the simple pushing and popping of the bufmod module.  It\n\
