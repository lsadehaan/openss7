...
static char const ident[] = "src/test/test-m2ua_as.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
Options:\n\
    ...
    -x, --transport DEVICE\n\
        device name to open for transport [default: %4$s].\n\
    -e, --exit\n\
...
\n\
", argv[0], devname, TEST_PORT_NUMBER, xptname);
}
