...
static char const ident[] = "src/drivers/ip_to_dlpi.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define IP2XINET_COPYRIGHT	"Copyright (c) 2008-2019  Monavacon Limited.  All Rights Reserved."
