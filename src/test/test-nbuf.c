 ...
 *  GENERAL OPERATION:
 *
 *  The test program opens STREAMS pipe and pushes the "nbuf" module onto one
 *  end of the pipe.
 *
 *  The test program exchanges SDTI primitives with one side of the open pipe
 *  and exchanges SDTI primitives and executes NBUF input-output controls on
 *  the other side of the pipe.  The side of the pipe with the "nbuf" STREAMS
 *  module pushed represents the user of the NBUF module.  The other side of
 ...
 *
 *
 *  This test arrangement results in a ferry-clip around the NBUF module,
...
#define test_group_1 "Pushing and popping the nbuf module"
...
This test case tests the simple pushing and popping of the nbuf module.  It\n\
