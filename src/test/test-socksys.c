...
static char const ident[] __attribute__ ((unused)) = "src/test/test-socksys.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
struct test_case {
	...
	test_case_1_2_stream_0, test_case_1_2_stream_1, test_case_1_2_stream_2}, &begin_tests, &end_tests, 0, 0, 0, __RESULT_SUCCESS}, {
		numb_case_1_3, tgrp_case_1_3, sgrp_case_1_3, name_case_1_3, xtra_case_1_3, desc_case_1_3, sref_case_1_3, {
