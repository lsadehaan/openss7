...
static char const ident[] = "src/drivers/x100p-ss7.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define X100P_COPYRIGHT		"Copyright (c) 2008-2020  Monavacon Limited.  All Rights Reserved."
...
MODULE_ALIAS("streams-x100p-ss7");
#endif
...
STATIC int streamscall xp_open(queue_t *, dev_t *, int, int, cred_t *);
STATIC int streamscall xp_close(queue_t *, int, cred_t *);
