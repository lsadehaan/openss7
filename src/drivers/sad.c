...
static char const ident[] = "src/drivers/sad.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SAD_COPYRIGHT	"Copyright (c) 2008-2019  Monavacon Limited.  All Rights Reserved."
