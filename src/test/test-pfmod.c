...
static char const ident[] __attribute__ ((unused)) = "src/test/test-pfmod.c (" PACKAGE_ENVR ") " PACKAGE_DATE;

/*
 *  This is a ferry-clip PFMOD conformance test program for testing the OpenSS7
 *  pfmod STREAMS module.
 *
 *  GENERAL OPERATION:
 *
 *  The test program opens STREAMS pipe and pushes the "pfmod" module onto one
 *  end of the pipe.
 *
 *  The test program exchanges SDTI primitives with one side of the open pipe
 *  and exchanges SDTI primitives and executes PFMOD input-output controls on
 *  the other side of the pipe.  The side of the pipe with the "pfmod" STREAMS
 *  module pushed represents the user of the PFMOD module.  The other side of
 ...
 *
 *
 *  This test arrangement results in a ferry-clip around the PFMOD module,
...
#define test_group_1 "Pushing and popping the pfmod module"
...
This test case tests the simple pushing and popping of the pfmod module.  It\n\
