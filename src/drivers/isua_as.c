...
static char const ident[] = "src/drivers/isua_as.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define ISUA_AS_COPYRIGHT	"Copyright (c) 2008-2020  Monavacon Limited.  All Rights Reserved."
