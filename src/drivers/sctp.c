...
static char const ident[] = "src/drivers/sctp.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SCTP_REVISION	"OpenSS7 src/drivers/sctp.c (" PACKAGE_ENVR ") " PACKAGE_DATE
