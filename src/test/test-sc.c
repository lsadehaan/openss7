...
static char const ident[] __attribute__ ((unused)) = "src/test/test-sc.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
preamble_0(int child)
{
	if (!test_fd[child] && test_open(child, devname, O_NONBLOCK | O_RDWR) != __RESULT_SUCCESS)
		return __RESULT_FAILURE;
	state++;
	if (test_ioctl(child, I_PUSH, (intptr_t) "sc") != __RESULT_SUCCESS)
		return __RESULT_FAILURE;
	state++;
	return __RESULT_SUCCESS;
}
...
#define name_case_1_1 "Open and close 1 SAD Stream and push the SC module."
...
#define name_case_1_2 "Open and close 3 SAD Streams and push the SC module."
...
static const char test_group_2[] = "STREAMS Configuration (SC) Module, ioctl(2).";
static const char sref_group_2[] = "STREAMS Configuration (SC) Module, sc(4) manual page.";
...
argument of NULL will return the number of modules loaded on the system."

int
test_case_2_1(int child)
{
	if (test_ioctl(child, SC_IOC_LIST, (intptr_t) NULL) != __RESULT_SUCCESS)
		return (__RESULT_FAILURE);
	state++;
...
sc_nmods value of zero (0) and a sc_mlist pointer of (NULL) will return\n\
the number of modules loaded on the system."
...
struct test_case {
	...
	test_case_0_1_stream_0, test_case_0_1_stream_1, test_case_0_1_stream_2}, &begin_sanity, &end_sanity, 0, 0, 0, __RESULT_INCONCLUSIVE}, {
		numb_case_1_1, tgrp_case_1_1, sgrp_case_1_1, name_case_1_1, xtra_case_1_1, desc_case_1_1, sref_case_1_1, {
	...
	test_case_2_1_stream_0, test_case_2_1_stream_1, test_case_2_1_stream_2}, &begin_tests, &end_tests, 0, 0, 0, __RESULT_SUCCESS}, {
		numb_case_2_2, tgrp_case_2_2, NULL, name_case_2_2, NULL, desc_case_2_2, sref_case_2_2, {
	test_case_2_2_stream_0, test_case_2_2_stream_1, test_case_2_2_stream_2}, &begin_tests, &end_tests, 0, 0, 0, __RESULT_SUCCESS}, {
		numb_case_2_3, tgrp_case_2_3, NULL, name_case_2_3, NULL, desc_case_2_3, sref_case_2_3, {
	test_case_2_3_stream_0, test_case_2_3_stream_1, test_case_2_3_stream_2}, &begin_tests, &end_tests, 0, 0, 0, __RESULT_SUCCESS}, {
		numb_case_2_4, tgrp_case_2_4, NULL, name_case_2_4, NULL, desc_case_2_4, sref_case_2_4, {
	test_case_2_4_stream_0, test_case_2_4_stream_1, test_case_2_4_stream_2}, &begin_tests, &end_tests, 0, 0, 0, __RESULT_SUCCESS}, {
		numb_case_2_5, tgrp_case_2_5, NULL, name_case_2_5, NULL, desc_case_2_5, sref_case_2_5, {
	test_case_2_5_stream_0, test_case_2_5_stream_1, test_case_2_5_stream_2}, &begin_tests, &end_tests, 0, 0, 0, __RESULT_SUCCESS}, {
	NULL,}
};
