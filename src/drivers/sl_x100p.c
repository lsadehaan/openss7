...
static char const ident[] = "src/drivers/sl_x100p.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SL_X100P_COPYRIGHT	"Copyright (c) 2008-2020  Monavacon Limited.  All Rights Reserved."
...
#define SL_X100P_BANNER		SL_X100P_DESCRIP	"\n" \
				SL_X100P_EXTRA		"\n" \
				SL_X100P_REVISION	"\n" \
				SL_X100P_COPYRIGHT	"\n" \
				SL_X100P_DEVICE		"\n" \
				SL_X100P_CONTACT
#define SL_X100P_SPLASH		SL_X100P_DEVICE		"\n" \
				SL_X100P_REVISION

#ifdef LINUX
MODULE_AUTHOR(SL_X100P_CONTACT);
MODULE_DESCRIPTION(SL_X100P_DESCRIP);
MODULE_SUPPORTED_DEVICE(SL_X100P_DEVICE);
...
#define DRV_ID		SL_X100P_DRV_ID
#define DRV_NAME	SL_X100P_DRV_NAME
#define CMAJORS		SL_X100P_CMAJORS
#define CMAJOR_0	SL_X100P_CMAJOR_0
#define UNITS		SL_X100P_UNITS
#ifdef MODULE
#define DRV_BANNER	SL_X100P_BANNER
#else				/* MODULE */
#define DRV_BANNER	SL_X100P_SPLASH
#endif				/* MODULE */
...
STATIC struct streamtab sl_x100pinfo = {
 ...
 *  -------------------------------------------------------------------------
 */
module_init(sl_x100pinit);
module_exit(sl_x100pterminate);
