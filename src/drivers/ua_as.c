...
static char const ident[] = "src/drivers/ua_as.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
 ...
 *  NPI).  The Stream, when freshly opened, is merely associated with the ASP and specific UA-AS
 ...
 *  to describe the configuration elements associatedw with the SCTP association.  UA-AS
...
#define UA_AS_COPYRIGHT	"Copyright (c) 2008-2020  Monavacon Limited.  All Rights Reserved."
...
#define UA_AS_BANNER	UA_AS_DESCRIP	"\n" \
			...
			UA_AS_DEVICE	"\n" \
			UA_AS_CONTACT	"\n"
#define UA_AS_SPLASH	UA_AS_DESCRIP	" - " \
			UA_AS_REVISION	"\n"

#ifdef LINUX
MODULE_AUTHOR(UA_AS_CONTACT);
MODULE_DESCRIPTION(UA_AS_DESCRIP);
MODULE_SUPPORTED_DEVICE(UA_AS_DEVICE);
#ifdef MODULE_LICENSE
MODULE_LICENSE(UA_AS_LICENSE);
...
#define UA_AS_DRV_ID	CONFIG_STREAMS_UA_AS_MODID
#define UA_AS_DRV_NAME	CONFIG_STREAMS_UA_AS_NAME
#define UA_AS_CMAJORS	CONFIG_STREAMS_UA_AS_NMAJORS
#define UA_AS_CMAJOR_0	CONFIG_STREAMS_UA_AS_MAJOR
#define UA_AS_UNITS	CONFIG_STREAMS_UA_AS_NMINORS

#define DRV_ID		UA_AS_DRV_ID
#define DRV_NAME	UA_AS_DRV_NAME
#define DRV_CMAJOR	UA_AS_CMAJOR_0
#ifdef MODULE
 ...
 *	autocloning features of Linux Fast-STREAMS.  This corresponds to the /dev/streams/ua-as/lm
 *	minor device node.
 *
 ...
 *	/dev/streams/clone/ua-as clone device node.
 *
 ...
 *	/dev/streams/ua-as/NNNN minor device node where NNNN is the minor device number.
 */
static streamscall int
...
static struct streamtab ua_asinfo = {
	.st_rdinit = &up_rinit,
	.st_wrinit = &up_winit,
 ...
 *  -------------------------------------------------------------------------
 */
module_init(ua_asinit);
module_exit(ua_asexit);
