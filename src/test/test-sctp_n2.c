...
static char const ident[] = "src/test/test-sctp_n2.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
test_case_3_5_1(int child)
{
	...
	struct sockaddr_in sin = { AF_INET, port, {addrs[2][0].sin_addr.s_addr}, 0 };
...
%1$s:\n\
    ...
    Copyright (c) 1997-2001  Brian F. G. Bidulock. All Rights Reserved.\n\
\n\
