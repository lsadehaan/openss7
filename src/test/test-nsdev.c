...
static char const ident[] __attribute__ ((unused)) = "src/test/test-nsdev.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
struct test_case {
	...
	test_case_1_1_stream_0, test_case_1_1_stream_1, test_case_1_1_stream_2}, &begin_tests, &end_tests, 0, 0, 0, __RESULT_FAILURE}, {
		numb_case_1_2, tgrp_case_1_2, sgrp_case_1_2, name_case_1_2, xtra_case_1_2, desc_case_1_2, sref_case_1_2, {
	test_case_1_2_stream_0, test_case_1_2_stream_1, test_case_1_2_stream_2}, &begin_tests, &end_tests, 0, 0, 0, __RESULT_FAILURE}, {
	NULL,}
};
