...
static char const ident[] __attribute__ ((unused)) = "src/test/test-mux.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
static char devname[256] = "/dev/streams/clone/mux";
